...
<body>
    <img src="<?php echo e(asset('img/bannerhd.jpg')); ?>"  class=" img-fluid position-relative" width="100%" height="50%"  >
    <div class="container-fluid">
        <div class="row flex-nowrap">
            
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0" style="background-color: rgb(236, 177, 240)">
                <nav>
                    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100" style="text-color:black">
                        <a href="/" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-black text-decoration-none">
                            <img src="<?php echo e(asset('img/DILG_Logo.png')); ?>" alt="Logo" width="50" height="50"  class="d-inline-block" > 
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                            ...
                            <li class="nav-item <?php echo e(request()->is('GADPh') ? 'active' : ''); ?>" style="width: 100%">
                                <a href="<?php echo e(route('GADPh.index')); ?>" class="nav-link align-middle px-0">
                                    <i class="bi bi-info-circle fnt"  ></i> <h5 class="ms-1 d-none d-sm-inline fnt">About</h5>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="#" class="nav-link px-0 align-middle">
                                    <i class="bi bi-phone fnt"  ></i> <h5 class="ms-1 d-none d-sm-inline fnt">Contact Us</h5></a>
                            </li>
                            <li>
                                <a href="https://www.facebook.com/dilgcar" class="nav-link px-0 align-middle">

                                    <i class="bi bi-facebook fnt">
                            ...
                            <li>
                                <a href="#" class="nav-link px-0 align-middle">
                                    <i class="bi bi-envelope fnt"> dilgcargad@gmail.com</i>
                                </a>
                            ...
                            <li>
                                <a href="#" class="nav-link px-0 align-middle">
                                    <i class="bi bi-telephone fnt"> (074) 422 3644</i>
                                </a>
            ...
            <div class="col py-3">
                <div class="card" style="text-align: center;box-shadow: 0 2px 10px 0 rgb(0, 0, 0);">
                    <h3 class="card-header"  style="background-color:  rgb(203, 162, 244); font-family: Lucida Handwriting;">
                        <b><?php echo $__env->yieldContent('title_head'); ?></b>
                    </h3>
                    <div class="card-body">
...
</html><?php /**PATH C:\Users\win10\Documents\LaravelProjects\DILG\GAD\resources\views/main_view.blade.php ENDPATH**/ ?>